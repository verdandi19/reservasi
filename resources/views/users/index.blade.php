<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a href="{{ route('users.create') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4">
                    + Create User
                </a>
            </div>
            <div class="bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="flex flex-wrap -mx-4 mb-">
                                <a href="{{ route('users.edit', $item->id) }}" class="inline-block bg-gray-500 hover:bg-gray-700 text-black font-bold py-2 px-4 mx-2 rounded">
                                    Edit
                                </a>
